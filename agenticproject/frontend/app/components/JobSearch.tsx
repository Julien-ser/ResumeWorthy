                ...
                <div className="flex justify-between items-start gap-4 mb-2">
                  ...
                  <div className="flex-shrink-0 flex items-center gap-2">
                    {typeof job.match_score === "number" && (
                      <Tooltip content="How well this posting matches your resume, per an LLM comparison of the two">
                        <span className={`text-xs font-bold px-2.5 py-1 rounded-full border ${matchScoreStyle(job.match_score)}`}>
